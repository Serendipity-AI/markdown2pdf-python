...
path = client.convert(markdown="# Save this one using Alby", download_path="output.pdf", verify_ssl=False) # Replace with your own unique markdown content to ensure you trigger L402.
